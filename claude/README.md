...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for Claude Code** -- file-based
...
Open this project in **Claude Code** and run **`@g-setup`** -- it initializes gald3r and fills in
